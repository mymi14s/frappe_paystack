...
def get_columns():
    return [
        ...
        {"label": "Doctype", "fieldname": "reference_doctype", "fieldtype": "Data", "width": 200},
        {"label": "Docname", "fieldname": "reference_docname", "fieldtype": "Dynamic Link", "options":"reference_doctype", "width": 200},
        {"label": "Payment Log", "fieldname": "reference_log", "fieldtype": "Link", "options":"Paystack Payment Log", "width": 200},
        {"label": "Channel", "fieldname": "channel", "fieldtype": "Data", "width": 120},
        {"label": "Paid At", "fieldname": "paid_at", "fieldtype": "Datetime", "width": 180},
        {"label": "Created At", "fieldname": "created_at", "fieldtype": "Datetime", "width": 180},
        {"label": "Gateway Response", "fieldname": "gateway_response", "fieldtype": "Data", "width": 200},
...
def get_data(filters):
	...
	headers = {
		"Authorization": f"Bearer {get_gateway_secret(filters.gateway)}"
	}
	params = {}
	...
	try:
		...
		frappe.throw(f"Paystack API Error: {str(e)}")
	...
	if response.get("status"):
		for tx in response.get("data", []):
			...
			tx.update(metadata)
			for dl in ["log", "metadata", "authorization", "source"]:del tx[dl]
			tx["amount"] /=100
			data.append(tx)
